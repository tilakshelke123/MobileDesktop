...
public class Feather1 {
	...
	public void testFeature1() {
		System.out.println("testFeature1 group1");
	}

	@Test( groups= {"Group1"})
	public void testFeature2() {
		System.out.println("testFeature2 group1");
	}
	
	@Test( groups= {"Group2"})
	public void testFeature3() {
		System.out.println("testFeature3 group2");
	}
	@Test( groups= {"Group3"},enabled = false)
	public void testFeature4() {
		System.out.println("testFeature4 ");
	}
	@Test( groups= {"Group4"})
	public void testFeature5() {
		System.out.println("testFeature5 group3");
	}
